  ...
  return (
    <section className="relative overflow-hidden pt-32 pb-20 px-6 lg:pt-36 lg:pb-28">
      <div className="absolute inset-0 -z-10">
        <motion.div
          className="absolute inset-0 bg-gradient-to-br from-[#08101f] via-[#0e1630] to-[#07101c]"
          animate={{
            background: [
              'linear-gradient(135deg, #08101f 0%, #0e1630 52%, #07101c 100%)',
              'linear-gradient(135deg, #071425 0%, #1f1435 52%, #081826 100%)',
              'linear-gradient(135deg, #08101f 0%, #0e1630 52%, #07101c 100%)',
            ],
          }}
      ...
      <div className="mx-auto grid w-full max-w-7xl items-center gap-12 lg:grid-cols-2">
        <motion.div
          ...
          className="space-y-8"
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-[10px] font-black uppercase tracking-[0.24em] text-[#7dd3fc]">
            <Sparkles className="h-4 w-4" /> Humanized Career Intelligence
          </div>

          <div className="space-y-5">
            <h1 className="text-6xl font-black leading-[0.95] tracking-tight md:text-8xl font-space-grotesk">
            ...
            <p className="max-w-xl text-lg leading-relaxed text-slate-300 md:text-2xl">
              A premium AI workspace that turns one resume upload into a clear plan, sharper signal, and better-fit roles.
            </p>
          </div>

          <motion.div
            className="rounded-[28px] border border-[#38bdf8]/25 bg-[#0b172f]/75 px-4 py-3 backdrop-blur-xl shadow-[0_0_30px_rgba(56,189,248,0.15)]"
            animate={{ boxShadow: ['0 0 20px rgba(56,189,248,0.10)', '0 0 34px rgba(56,189,248,0.22)', '0 0 20px rgba(56,189,248,0.10)'] }}
            transition={{ duration: 2.6, repeat: Infinity, ease: 'easeInOut' }}
          >
            <div className="text-[10px] font-black uppercase tracking-[0.22em] text-[#7dd3fc]">Live AI Status</div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link href="/dashboard/upload">
              <Button className="h-12 rounded-full bg-gradient-to-r from-[#2563EB] via-[#6366F1] to-[#06B6D4] px-7 font-black text-white shadow-[0_0_34px_rgba(99,102,241,0.42)] transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_48px_rgba(56,189,248,0.52)] active:scale-[0.98]">
          ...
          <div className="grid gap-2 text-sm text-slate-300 md:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-3 py-2">Step 1: Upload resume</div>
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-3 py-2">Step 2: AI analyzes</div>
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-3 py-2">Step 3: Insights appear</div>
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-3 py-2">Step 4: Best jobs matched</div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative rounded-[36px] border border-white/12 bg-white/[0.05] p-5 shadow-[0_30px_90px_rgba(2,6,23,0.6)] backdrop-blur-2xl">
            <motion.div
            ...
            <div className="mb-4 flex items-center justify-between border-b border-white/10 pb-3">
              ...
              <div className="text-[10px] font-black uppercase tracking-[0.24em] text-slate-300">AI Pipeline</div>
            </div>
          ...
          <motion.div
            className="absolute -bottom-4 left-8 rounded-[20px] border border-[#38bdf8]/35 bg-[#0b172f]/90 px-4 py-3 text-white backdrop-blur-xl"
            animate={{ y: [0, -6, 0] }}
